...
#1_s
intel1s <- mean(dataFemale$intel1_s, na.rm=TRUE)
attr1s <- mean(dataFemale$attr1_s, na.rm=TRUE)
sinc1s <- mean(dataFemale$sinc1_s, na.rm=TRUE)
fun1s <- mean(dataFemale$fun1_s, na.rm = TRUE)
amb1s <- mean(dataFemale$amb1_s, na.rm = TRUE)
shar1s <- mean(dataFemale$shar1_s, na.rm = TRUE)
